  ...
  devServer: {
    before:function(app){
       app.get('/api/area',function(req,res){
        superagent.get('https://api.douban.com/v2/movie/in_theaters')
        .query(req.query)
        .end((err,data)=>{
            if(err) {
              console.log(err)
...
// https://api.douban.com/v2/movie/subject/26942674   
      app.get('/api/subject',function(req,res){
        ...
        superagent.post(`https://api.douban.com/v2/movie/subject/${info}`)
        .end((err,data)=>{
            if(err) {
              console.log(err)
            }
    ...
    proxy: {
      //'/douban':{
      //  chanheOrigin:true,
      //  target:'https://api.douban.com/v2/movie/in_theaters',
      //  pathRewrite:{'^/douban':''}
      //}
    },
